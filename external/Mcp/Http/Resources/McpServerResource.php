...
class McpServerResource extends JsonResource
{
     ...
     * @param  mixed  $revealEnv  Only literal true reveals env; collection mapInto passes int keys — must not count as true.
     */
    public function __construct($resource, mixed $revealEnv = false)
    {
    ...
    public function toArray(Request $request): array
    {
        ...
        $envKeys = array_values(array_filter(array_keys($env), static fn ($k): bool => is_string($k)));
